...
checkPassword = async (username, plaintextPassword) => {
    ...
    if (globalStore[username]) {
        ...
        if (result) {
            ...
            console.log(`Yay!, ${username}, you're who you say you are!`)
        }
        else {
            // TODO: Display message for invalid credentials
            console.log(`You're not ${username}! Sending strike team now`)
        }
    }
    else {
...
hashPassword = async (username, password) => {
    ...
    console.log(`New user info is Username: ${username} Hashed Password: ${hashedPassword}`)
}
